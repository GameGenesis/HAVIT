...
- On public repo, conceal ```android/app/google-services.json``` and ```android/app/src/main/res/raw/service_account.json``` as they the API keys for Firebase and Firestore, respectively.
